...
# Пока что, при локальном импорте можно парсить список приходящий и если хотя бы один job.status == 'pending', тогда еще не все...
# При загрузке из облака приходит 200, если запись о креденшиалах есть в БД.
